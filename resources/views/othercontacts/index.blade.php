...
<div class="container">
    ...
    <h2 class="text-center">Other Contact</h2>
    <hr>
...
@endif --}}
          ...
          @foreach($othercontact as $contactgroups)
          <tr>
            <td >  <a  href="{{route('contactgroup.show', $contactgroups->id)}}"> {{$contactgroups->resourceName}}</a></td>
